...
!(function (e, t) {
  ...
  function p(e, o, p) {
    ...
    var c = { scrollLeft: 0, scrollTop: 0 },
      u = { x: 0, y: 0 };
    return p || ("body" !== a(o) && (c = o !== r(o) && i(o) ? { scrollLeft: o.scrollLeft, scrollTop: o.scrollTop } : n(o)), i(o) ? (((u = t(o)).x += o.clientLeft), (u.y += o.clientTop)) : (o = s(o)) && (u.x = f(o))), { x: e.left + c.scrollLeft - u.x, y: e.top + c.scrollTop - u.y, width: e.width, height: e.height };
  }
  function c(e) {
  ...
  function x(e) {
    ...
    return function (e, t, i) {
      ...
      void 0 === i && (i = n);
      var s = { placement: "bottom", orderedModifiers: [], options: Object.assign({}, F, {}, n), modifiersData: {}, elements: { reference: e, popper: t }, attributes: {}, styles: {} },
        f = [],
        u = !1,
        d = {
          state: s,
          setOptions: function (i) {
            return (
              ...
              s.orderedModifiers.forEach(function (e) {
                var t = e.name,
                  r = e.options;
                (r = void 0 === r ? {} : r), "function" == typeof (e = e.effect) && ((t = e({ state: s, name: t, instance: d, options: r })), f.push(t || function () {}));
              }),
              d.update()
            );
          },
          forceUpdate: function () {
            if (!u) {
              ...
              if (y(t, (e = e.popper)))
                for (
                  s.rects = { reference: p(t, h(e), "fixed" === s.options.strategy), popper: c(e) },
                    s.reset = !1,
                  ...
                  if (!0 === s.reset) (s.reset = !1), (t = -1);
                    ...
                    e = r.fn;
                    var n = r.options;
                    (n = void 0 === n ? {} : n), (r = r.name), "function" == typeof e && (s = e({ state: s, options: n, name: r, instance: d }) || s);
                  }
            }
          },
          update: g(function () {
  ...
  function L(e, o) {
    if ("viewport" === o) e = k({ width: (e = r(e)).innerWidth, height: e.innerHeight, x: 0, y: 0 });
    else if (i(o)) e = t(o);
    else {
      var a = s(e);
  ...
  function H(e, r) {
    ...
    (p = e.rects.popper), (a = P(o((c = e.elements[c ? ("popper" === i ? "reference" : "popper") : i])) ? c : s(e.elements.popper), a, f)), (c = O({ reference: (f = t(u)), element: p, strategy: "absolute", placement: r })), (p = k(Object.assign({}, p, {}, c))), (f = "popper" === i ? p : f);
    var d = { top: a.top - f.top + n.top, bottom: f.bottom - a.bottom + n.bottom, left: a.left - f.left + n.left, right: f.right - a.right + n.right };
  ...
  var q = ["top", "bottom", "right", "left"],
    ...
    V = [
      ...
      },
      {
        ...
        fn: function (e) {
          var t = e.state;
          t.modifiersData[e.name] = O({ reference: t.rects.reference, element: t.rects.popper, strategy: "absolute", placement: t.placement });
        },
        data: {},
      },
      {
      ...
      },
      {
        ...
        effect: function (e) {
          var t = e.state,
            r = { popper: { position: "absolute", left: "0", top: "0", margin: "0" }, arrow: { position: "absolute" }, reference: {} };
          return (
        ...
        fn: function (e) {
          var t = e.state,
            ...
            o = (e = S.reduce(function (e, r) {
              ...
              return (o = (o = s[0]) || 0), (s = ((s = s[1]) || 0) * a), (i = 0 <= ["left", "right"].indexOf(i) ? { x: s, y: o } : { x: o, y: s }), (e[r] = i), e;
            }, {}))[t.placement],
            i = o.y;
          ...
          if (((e = e.name), !t.modifiersData[e]._skip)) {
                  ...
                  ? (function (e, t) {
                      ...
                      var r = t.boundary,
                        ...
                        s = (
                          ...
                          return (t[i] = H(e, { placement: i, boundary: r, rootBoundary: n, padding: o })[b(i)]), t;
                        }, {});
                      return Object.keys(s).sort(function (e, t) {
                        return s[e] - s[t];
                      });
                    })(t, { placement: r, boundary: i, rootBoundary: a, padding: o, flipVariations: s })
                  : r
              );
            }, []);
            ...
            for (var u = p[0], d = 0; d < p.length; d++) {
              var l = p[d],
                ...
                g = v ? "width" : "height",
                y = H(t, { placement: l, boundary: i, rootBoundary: a, padding: o });
              if (
      ...
      },
      {
        ...
        fn: function (e) {
          ...
          var a = r.tetherOffset,
            s = void 0 === a ? 0 : a;
          (r = H(t, { boundary: r.boundary, rootBoundary: r.rootBoundary, padding: r.padding })), (a = b(t.placement));
          ...
          if (((s = { x: 0, y: 0 }), o)) {
            ...
            var x = d[u] + r[v],
              ...
              M = i ? -m[y] / 2 : 0,
              j = "start" === f ? l[y] : m[y];
            (f = "start" === f ? -m[y] : -l[y]), (m = t.elements.arrow), (m = i && m ? c(m) : { width: 0, height: 0 });
      ...
      },
      {
        ...
        effect: function (e) {
          ...
          e = e.name;
          var n = r.element;
          (n = void 0 === n ? "[data-popper-arrow]" : n), (r = void 0 === (r = r.padding) ? 0 : r), ("string" != typeof n || (n = t.elements.popper.querySelector(n))) && E(t.elements.popper, n) && ((t.elements.arrow = n), (t.modifiersData[e + "#persistent"] = { padding: W("number" != typeof r ? r : B(r, q)) }));
        },
        requires: ["popperOffsets"],
      ...
      },
      {
        ...
        fn: function (e) {
          ...
          var r = t.rects.reference,
            ...
            a = H(t, { altBoundary: !0 });
          (r = R(i, r)), (n = R(a, n, o)), (o = T(r)), (a = T(n)), (t.modifiersData[e] = { referenceClippingOffsets: r, popperEscapeOffsets: n, isReferenceHidden: o, hasPopperEscaped: a }), (t.attributes.popper = Object.assign({}, t.attributes.popper, { "data-popper-reference-hidden": o, "data-popper-escaped": a }));
        },
      },
    ],
